...
try {
    ...
    if ($groups->num_rows == 0) {
        echo json_encode(new StudentResponse("failure", error: new ErrorResponse(404, "No groups found for student ID $studentId")));
        return;
    }
    ...
    echo json_encode(new StudentResponse("success", $groupsData));
