...
if (!isset($inputData['userID'], $inputData['rolesCode']) || !is_numeric($inputData['rolesCode'])) {
    http_response_code(400);
    echo json_encode(new GetResponse('failure', [
        'errorCode' => 400,
        'errorMessage' => 'Bad request. Missing userID or rolesCode.'
    ]));
    return;
}
...
if (!$response) {
    ...
    echo json_encode(new GetResponse('failure', [
        'errorCode' => 500,
        'errorMessage' => 'Error assigning role ' . $roleCode
    ]));
    return;
}
