...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarText">
                  <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/js/modules/loginAdmin.php">Administradores</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/js/modules/index.html">Registro</a>
                    </li>
                    <li class="nav-item">
    ...
    <main class="container my-5">
      ...
      <div class="mt-4">
        <a href="/js/modules/admisiones.html" class="text-decoration-none" id="back-link">← Regresar</a>
      </div>
    </main>
    <footer>
