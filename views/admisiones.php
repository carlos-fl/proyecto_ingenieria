            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarText">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="/js/modules/index.php">Registro</a>
                        </li>
                        <li class="nav-item">
        ...
        <section class="main-navbar">
            <div class="container text-center">
                <div class="row align-items-center">
                    <div class="col">
                        <a href="/js/modules/inscripciones.php">
                            <div class="custom-box">Inscripciones</div>
                        </a>
                    </div>
                    <div class="col">
                        <a href="/js/modules/resultados.php">
        ...
        <section>
            <div class="container text-center">
                <div class="row row-cols-4">
                    <a href="/js/modules/requisitosCarreras.php"><div class="col"><img src="/assets/img/Odontologia-color.png" alt=""></div></a>
                    <a href="/js/modules/construccion.php"><div class="col"><img src="/assets/img/Ciencias-color.png" alt=""></div></a>
                    <a href="/js/modules/construccion.php"><div class="col"><img src="/assets/img/Ciencias-Economicas-color.png" alt=""></div></a>
                    <a href="/js/modules/construccion.php"><div class="col"><img src="/assets/img/Ciencias-Juridicas-color.png" alt=""></div></a>
                    <a href="/js/modules/construccion.php"><div class="col"><img src="/assets/img/Ciencias-Sociales-color.png" alt=""></div></a>
                    <a href="/js/modules/construccion.php"><div class="col"><img src="/assets/img/Ingenieria-color.png" alt=""></div></a> 
                </div>
              </div>
        </section>
    </main>
