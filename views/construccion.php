            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarText">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" aria-current="views/construccion.php" href="#">Estudiantes</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="views/construccion.php">Docentes</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="views/construccion.php" data-bs-toggle="modal" data-bs-target="#reviewerModal">Revisores</a>
                        </li>
                        <li class="nav-item">
