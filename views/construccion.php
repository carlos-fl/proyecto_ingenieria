...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarText">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="/js/modules/index.php">Registro</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" aria-current="/js/modules/construccion.php" href="#">Estudiantes</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/js/modules/construccion.php">Docentes</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/js/modules/construccion.php" data-bs-toggle="modal" data-bs-target="#reviewerModal">Revisores</a>
                        </li>
                        <li class="nav-item">
    ...
    <main>
        <div class="top-bar">
            ...
            <div class="banner-container" id="underConstruccion">
                1
            </div>
        </div>
    </main>
